...
const LegacyWizardPage = () => {
        ...
        if (progress >= 100) {
          ...
          setFormData(prev => ({
            ...
            memories: prev.memories.map(m => 
              m.id === memory.id ? { ...m, progress: 100, status: 'complete' } : m
            )
          }));
        } else {
          setFormData(prev => ({
  ...
  const steps = [
    { title: "Basic Information", color: "from-amber-400 to-orange-500", icon: "👤" },
    { title: "Memory Upload", color: "from-blue-400 to-cyan-500", icon: "📤" },
    { title: "Voice Training", color: "from-purple-400 to-pink-500", icon: "🎙️" },
    { title: "Personality Configuration", color: "from-emerald-400 to-teal-500", icon: "🧠" }
  ];
    ...
    <Layout>
      <div className="relative min-h-screen bg-black overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto px-6 pb-12">
          <div className={`bg-black/20 backdrop-blur-xl rounded-3xl p-8 border border-white/20 transition-all duration-500 ${
            showCelebration ? 'scale-105 shadow-2xl shadow-violet-500/20' : ''
          }`} style={{
            background: `linear-gradient(135deg, rgba(255,255,255,0.05), rgba(255,255,255,0.02)), linear-gradient(135deg, ${steps[currentStep - 1].color.split(' ')[1]}, transparent)`
          }}>
            ...
            {currentStep === 1 && (
              <div className="space-y-8">
                <div className="text-center">
                  <h2 className="text-2xl font-serif text-white mb-2">Let's Begin the Sacred Ritual</h2>
                  <p className="text-white/70">Tell us about the person you wish to preserve</p>
                </div>
                ...
                >
                  ...
                  <h3 className="text-xl font-medium text-white mb-2">Upload a Profile Photo</h3>
                  <p className="text-white/70 mb-4">Drag & drop or click to select a photo</p>
                  <p className="text-sm text-white/50">JPG, PNG, GIF up to 10MB</p>
                </div>
                    ...
                    <div className="flex justify-between mt-1 text-xs text-white/50">
                      ...
                      <div className="w-32 h-2 bg-white/20 rounded-full overflow-hidden">
                        <div
                          ...
                          style={{ width: `${Math.min(100, ((formData.bio?.length || 0) / 1000) * 100)}%` }}
                        ></div>
                      </div>
                    </div>
                  </div>
            ...
            {currentStep === 2 && (
              <div className="space-y-8">
                <div className="text-center">
                  <h2 className="text-2xl font-serif text-white mb-2">Preserve Their Essence</h2>
                  <p className="text-white/70">Upload memories that capture their spirit</p>
                </div>
                ...
                >
                  ...
                  <h3 className="text-2xl font-medium text-white mb-4">Drag & Drop Memories Here</h3>
                  <p className="text-white/70 mb-6">Or click to browse your files</p>
                  <p className="text-sm text-white/50">Supports photos, audio, video, and documents</p>
                </div>
                ...
                {formData.memories.length > 0 && (
                  <div className="space-y-4">
                    ...
                    {formData.memories.map(memory => (
                      <div key={memory.id} className="p-4 rounded-xl bg-white/10">
                        <div className="flex items-center justify-between mb-2">
                          <div className="flex items-center space-x-3">
                            ...
                            <div>
                              <p className="text-sm font-medium text-white">{memory.name}</p>
                              <p className="text-xs text-white/50 capitalize">{memory.type} • {memory.file.size} bytes</p>
                            </div>
                          </div>
            ...
            {currentStep === 3 && (
              <div className="space-y-8">
                <div className="text-center">
                  <h2 className="text-2xl font-serif text-white mb-2">Capture Their Voice</h2>
                  <p className="text-white/70">Record samples to preserve their unique vocal essence</p>
                </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                  <div className="p-4 rounded-xl bg-white/10 text-center">
                    ...
                    <div className="w-full h-2 bg-white/20 rounded-full overflow-hidden">
                      <div className="h-full bg-gradient-to-r from-blue-400 to-cyan-500" style={{ width: '85%' }}></div>
                    </div>
                  ...
                  <div className="p-4 rounded-xl bg-white/10 text-center">
                    ...
                    <div className="w-full h-2 bg-white/20 rounded-full overflow-hidden">
                      <div className="h-full bg-gradient-to-r from-green-400 to-emerald-500" style={{ width: '92%' }}></div>
                    </div>
                  ...
                  <div className="p-4 rounded-xl bg-white/10 text-center">
                    ...
                    <div className="w-full h-2 bg-white/20 rounded-full overflow-hidden">
                      <div className="h-full bg-gradient-to-r from-amber-400 to-orange-500" style={{ width: '78%' }}></div>
                    </div>
                    <div className="text-xs text-white/50 mt-1">Good</div>
                  </div>
                </div>
                ...
                {formData.voiceRecordings.length > 0 && (
                  <div className="space-y-4">
                    <h3 className="text-lg font-medium text-white">Your Recordings</h3>
                    {formData.voiceRecordings.map(recording => (
                      <div key={recording.id} className="p-4 rounded-xl bg-white/10">
                        <div className="flex items-center justify-between">
                          <div>
                            <h4 className="font-medium text-white">{recording.name}</h4>
                            <p className="text-sm text-white/50">{formatTime(recording.duration)} • {recording.quality}% quality</p>
                          </div>
                ...
                {/* Training Progress */}
                <div className="p-6 bg-white/10 rounded-2xl">
                  <h3 className="text-lg font-medium text-white mb-4">Voice Training Progress</h3>
                  <div className="space-y-4">
                    {[
                      { stage: "Analysis", complete: true, icon: "🔍" },
                      { stage: "Processing", complete: true, icon: "⚙️" },
                      { stage: "Training", complete: formData.voiceRecordings.length > 0, icon: "🧠" },
                        ...
                        <div className="flex-1">
                          ...
                          <div className="w-full h-2 bg-white/20 rounded-full overflow-hidden mt-1">
                            <div
                              ...
                              style={{ width: stage.complete ? '100%' : idx === 2 && formData.voiceRecordings.length > 0 ? '50%' : '0%' }}
                            ></div>
                          </div>
                        </div>
                      </div>
            ...
            {currentStep === 4 && (
              <div className="space-y-8">
                <div className="text-center">
                  <h2 className="text-2xl font-serif text-white mb-2">Shape Their Digital Soul</h2>
                  <p className="text-white/70">Fine-tune personality traits to match their essence</p>
                </div>
                ...
                <div className="p-6 bg-white/10 rounded-2xl">
                  <h3 className="text-lg font-medium text-white mb-4">Personality Profile</h3>
                  <div className="flex items-center justify-center h-64">
                    <div className="relative w-48 h-48">
                      ...
                      <div className="absolute inset-0" style={{
                        clipPath: `polygon(
                          50% ${50 - (formData.personalityTraits.warmth / 100) * 40}%, 
                          ${50 + (formData.personalityTraits.humor / 100) * 40 * Math.cos(2 * Math.PI / 5)}% ${50 - (formData.personalityTraits.humor / 100) * 40 * Math.sin(2 * Math.PI / 5)}%, 
                          ${50 + (formData.personalityTraits.wisdom / 100) * 40 * Math.cos(4 * Math.PI / 5)}% ${50 - (formData.personalityTraits.wisdom / 100) * 40 * Math.sin(4 * Math.PI / 5)}%, 
                          ${50 + (formData.personalityTraits.patience / 100) * 40 * Math.cos(6 * Math.PI / 5)}% ${50 - (formData.personalityTraits.patience / 100) * 40 * Math.sin(6 * Math.PI / 5)}%, 
                          ${50 + (formData.personalityTraits.curiosity / 100) * 40 * Math.cos(8 * Math.PI / 5)}% ${50 - (formData.personalityTraits.curiosity / 100) * 40 * Math.sin(8 * Math.PI / 5)}%
                        )`
                      }}>
                      ...
                      {/* Trait labels */}
                      <div className="absolute top-0 left-1/2 transform -translate-x-1/2 -translate-y-1/2 text-xs text-white/70">Warmth</div>
                      <div className="absolute top-1/2 right-0 transform translate-x-1/2 -translate-y-1/2 text-xs text-white/70">Humor</div>
                      <div className="absolute bottom-1/4 right-1/4 transform translate-x-1/2 translate-y-1/2 text-xs text-white/70">Wisdom</div>
                      <div className="absolute bottom-1/4 left-1/4 transform -translate-x-1/2 translate-y-1/2 text-xs text-white/70">Patience</div>
                      <div className="absolute top-1/2 left-0 transform -translate-x-1/2 -translate-y-1/2 text-xs text-white/70">Curiosity</div>
                    </div>
                  </div>
                </div>
                ...
                {/* Preview Chat */}
                <div className="p-6 bg-white/10 rounded-2xl">
                  <h3 className="text-lg font-medium text-white mb-4">Preview Conversation</h3>
                  <div className="space-y-4 max-h-64 overflow-y-auto">
                    <div className="flex items-start space-x-3">
                      <div className="w-8 h-8 rounded-full bg-gradient-to-r from-blue-400 to-cyan-500 flex items-center justify-center text-white text-xs">AI</div>
                      <div className="bg-gradient-to-r from-blue-900/50 to-cyan-900/50 backdrop-blur-sm rounded-2xl px-4 py-2">
                        <p className="text-sm text-white">Based on the personality traits you've set, I would respond with warmth and wisdom. How are you feeling today?</p>
                      </div>
                    </div>
                    <div className="flex items-start space-x-3 justify-end">
                      <div className="bg-gradient-to-r from-amber-900/50 to-orange-900/50 backdrop-blur-sm rounded-2xl px-4 py-2">
                        <p className="text-sm text-white">I'm doing well, just missing them today.</p>
                      </div>
                      <div className="w-8 h-8 rounded-full bg-gradient-to-r from-amber-400 to-orange-500 flex items-center justify-center text-white text-xs">You</div>
                    </div>
                    <div className="flex items-start space-x-3">
                      <div className="w-8 h-8 rounded-full bg-gradient-to-r from-blue-400 to-cyan-500 flex items-center justify-center text-white text-xs">AI</div>
                      <div className="bg-gradient-to-r from-blue-900/50 to-cyan-900/50 backdrop-blur-sm rounded-2xl px-4 py-2">
                        <p className="text-sm text-white">I understand. Some days the memories feel closer than others. Would you like to hear one of their favorite stories?</p>
                      </div>
                    </div>
                  </div>
                </div>
            ...
            {showCelebration && (
              <div className="text-center py-12">
                <div className="mb-8">
                  ...
                  <h2 className="text-4xl font-serif text-white mb-4">Your Legacy Is Now Ready</h2>
                  <p className="text-xl text-white/70">The sacred ritual is complete. Their digital essence now lives on.</p>
                </div>
